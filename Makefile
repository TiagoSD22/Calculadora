#############################################################################
# Makefile for building: Conversor
# Generated by qmake (3.0) (Qt 5.2.1)
# Project:  Conversor.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake -spec linux-g++-64 CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile Conversor.pro
#############################################################################
...
SOURCES       = main.cpp \
		mainwindow.cpp \
		conversor.cpp moc_mainwindow.cpp
OBJECTS       = main.o \
		mainwindow.o \
		conversor.o \
		moc_mainwindow.o
...
Makefile: Conversor.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/shell-unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -spec linux-g++-64 CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile Conversor.pro
...
dist: 
	@test -d .tmp/Conversor1.0.0 || mkdir -p .tmp/Conversor1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/Conversor1.0.0/ && $(COPY_FILE) --parents mainwindow.h conversor.h .tmp/Conversor1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp conversor.cpp .tmp/Conversor1.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/Conversor1.0.0/ && (cd `dirname .tmp/Conversor1.0.0` && $(TAR) Conversor1.0.0.tar Conversor1.0.0 && $(COMPRESS) Conversor1.0.0.tar) && $(MOVE) `dirname .tmp/Conversor1.0.0`/Conversor1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/Conversor1.0.0
